...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7763229951').split()]  #Admin Id
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002367446556').split()] #Movie Database Channel Id
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002334193967'))  #Log Channel Id
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002334193967'))  #Streming Log Channel Id
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002467015295'))  #Movie Update Channel Id
...
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002348758566'))

IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002476467166')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002334193967')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
...
#Othes
TMDB_API = environ.get("TMDB_API", "32b004469c6cda2fd6169f4d1e8a866e")
...
MSG_ALRT = environ.get('MSG_ALRT', 'Sʜᴀʀᴇ & Sᴜᴘᴘᴏʀᴛ Us 🗿')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/ACX_DISCUSSION') #Support Chat Link with https://
